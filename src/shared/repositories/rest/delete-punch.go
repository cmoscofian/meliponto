...
// client.
func NewDeletePunch(c restclient.Client) repository.DeletePunchClient {
	if c == nil {
...
func (d deletePunch) DeletePunchByID(token, punchID string) (*entity.PunchResponse, error) {
